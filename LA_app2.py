...
@st.cache_data
def load_data():
    return pd.read_csv("data/LA_clean.csv")
...
def show_interactive_map():
    ...
    listings = pd.read_csv("data/LA_clean.csv", usecols=columns_to_load)
...
st.sidebar.image("images/airbnbwhite.png", width=150)
